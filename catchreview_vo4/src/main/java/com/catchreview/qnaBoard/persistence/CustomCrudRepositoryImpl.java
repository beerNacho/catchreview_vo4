...
import com.catchreview.qnaBoard.domain.QQnaReply;
...
@Log
public class CustomCrudRepositoryImpl extends QuerydslRepositorySupport implements CustomQnaBoard{
	...
	public Page<Object[]> getCustomPage(String type, String keyword, Pageable page) {
		...
		QQnaBoard b = QQnaBoard.qnaBoard;
		QQnaReply r = QQnaReply.qnaReply;
		
		JPQLQuery<QnaBoard> query = from(b);
